...
| Stage 2 | STFT/CWT 时频分支与多视图融合 | Pending | 新增 on-the-fly STFT/CWT 特征、时频 CNN 分支和 I/Q + 时频融合模型 | 未开始 | 待创建 | 基于 Stage 1.6 真实 subset baseline 设计工程消融，论文实验需补 full baseline |
